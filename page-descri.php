<?php
    ...
    if(isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM $table  WHERE id = $id AND id_user = $userId $UrlWhere";
        ...
        while($Part=Database::fetch_array($result)){
            ...
            if(file_exists($pageFinale)){
                ...
                $base_html = str_replace( ' src="img/' , ' src="'.api_get_path(WEB_PLUGIN_PATH).'chamilo_h5p/editor/img/', $base_html );
